angular.module('mopsiApp', ['underscore', 'ui.bootstrap', 'dialogs.main', 'ui.router', 'ngResource', 'mopsiApp.controllers', 'mopsiApp.services', 'mopsiApp.filters', 'angularUtils.directives.dirPagination', 'ngAnimate']);
